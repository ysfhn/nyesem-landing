...
export default function LogoBar() {
  ...
  return (
    <section className="relative py-16 bg-dark-900 overflow-hidden" aria-label="Nyesem'in mevcut olduğu şehirler">
      ...
      {/* Marquee */}
      <div className="relative" role="marquee" aria-label="Desteklenen şehirler listesi">
        ...
        <div className="flex animate-marquee hover:[animation-play-state:paused]" aria-hidden="false">
          {doubled.map((partner, i) => (
            <div
              key={i}
              className="flex items-center gap-2 mx-8 px-5 py-2.5 glass-light rounded-full whitespace-nowrap hover:bg-white/8 transition-all duration-300 border border-white/5 hover:border-brand-400/15"
            >
